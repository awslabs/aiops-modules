...
stack = DeployEndpointStack(
    ...
    sagemaker_domain_id=app_settings.module_settings.sagemaker_domain_id,
    sagemaker_domain_arn=app_settings.module_settings.sagemaker_domain_arn,
    ...
    enable_network_isolation=app_settings.module_settings.enable_network_isolation,
