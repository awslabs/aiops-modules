...
class ServiceCatalogStack(Stack):
    def __init__(
        ...
        dev_vpc_id: Optional[str],
        dev_subnet_ids: Optional[List[str]],
        dev_security_group_ids: Optional[List[str]],
        pre_prod_account_id: Optional[str],
        pre_prod_region: Optional[str],
        pre_prod_vpc_id: Optional[str],
        pre_prod_subnet_ids: Optional[List[str]],
        pre_prod_security_group_ids: Optional[List[str]],
        prod_account_id: Optional[str],
        prod_region: Optional[str],
        prod_vpc_id: Optional[str],
        prod_subnet_ids: Optional[List[str]],
        prod_security_group_ids: Optional[List[str]],
        **kwargs: Any,
    ) -> None:
