    ...
    const modelPackageGroupPolicy = new iam.PolicyDocument({
      statements: [
        new iam.PolicyStatement({
          ...
          resources: [
            `arn:${cdk.Aws.PARTITION}:sagemaker:${cdk.Stack.of(this).region}:${cdk.Stack.of(this).account}:model-package-group/${modelPackageGroupName}`,
          ],
          principals: allCrossAccountPrincipals,
        }),
        new iam.PolicyStatement({
          ...
          resources: [
            `arn:${cdk.Aws.PARTITION}:sagemaker:${cdk.Stack.of(this).region}:${cdk.Stack.of(this).account}:model-package/${modelPackageGroupName}/*`,
          ],
          principals: allCrossAccountPrincipals,
        }),
      ],
      ...
      document: new iam.PolicyDocument({
        statements: [
          ...
          new iam.PolicyStatement({
            actions: ['sagemaker:*'],
            notResources: [
              `arn:${cdk.Aws.PARTITION}:sagemaker:*:*:domain/*`,
              `arn:${cdk.Aws.PARTITION}:sagemaker:*:*:user-profile/*`,
              `arn:${cdk.Aws.PARTITION}:sagemaker:*:*:app/*`,
              `arn:${cdk.Aws.PARTITION}:sagemaker:*:*:flow-definition/*`,
            ],
          }),
          new iam.PolicyStatement({
            actions: [
          ...
          new iam.PolicyStatement({
            ...
            resources: [
              sagemakerArtifactsBucket.bucketArn,
              `${sagemakerArtifactsBucket.bucketArn}/*`,
              `arn:${cdk.Aws.PARTITION}:s3:::sagemaker-*`,
            ],
          }),
          new iam.PolicyStatement({
          ...
          new iam.PolicyStatement({
            ...
            effect: iam.Effect.ALLOW,
            resources: [
              `arn:${cdk.Aws.PARTITION}:kms:${cdk.Stack.of(this).region}:${cdk.Stack.of(this).account}:key/*`,
            ],
          }),
        ],
      }),
