...
stack = SagemakerStudioStack(
    ...
    idle_timeout_in_minutes=app_settings.parameters.idle_timeout_in_minutes,
    max_idle_timeout_in_minutes=app_settings.parameters.max_idle_timeout_in_minutes,
    min_idle_timeout_in_minutes=app_settings.parameters.min_idle_timeout_in_minutes,
