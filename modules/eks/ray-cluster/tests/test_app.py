...
def stack_defaults():
    with mock.patch.dict(os.environ, {}, clear=True):
        ...
        os.environ["SEEDFARMER_PARAMETER_EKS_HANDLER_ROLE_ARN"] = "arn:aws:iam::123456789012:role/eks-testing-XXXXXX"
        ...
        os.environ["SEEDFARMER_PARAMETER_SERVICE_ACCOUNT_NAME"] = "name"
