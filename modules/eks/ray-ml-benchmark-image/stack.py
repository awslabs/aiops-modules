...
class RayImagePublishingStack(cdk.Stack):
    def __init__(
        self,
        scope: Construct,
        id: str,
        ...
        **kwargs: Any,
        ...
        cdk.Tags.of(scope=cast(IConstruct, self)).add(
            key="Deployment", value=app_prefix[:64]
        )

        repo = ecr.Repository.from_repository_name(
            self, "ECR", repository_name=ecr_repo_name
        )
