    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        service_account = eks_cluster.add_service_account(
            "OrchestratorServiceAccount", name=module_name, namespace=namespace_name
        )
        ...
        rbac_role_binding = eks_cluster.add_manifest(
            "rbac-orchestrator-role-binding",
            {
                "apiVersion": "rbac.authorization.k8s.io/v1",
                "kind": "RoleBinding",
        ...
        eks_cluster.add_manifest(
            "rbac-orchestrator-role-default",
            {
                "apiVersion": "rbac.authorization.k8s.io/v1",
                "kind": "Role",
                "metadata": {"name": f"default-{module_name}", "namespace": "default"},
                "rules": [
                    {
                        "apiGroups": ["*"],
                        "resources": ["*"],
        ...
        rbac_role_binding = eks_cluster.add_manifest(
            "rbac-orchestrator-role-binding-default",
            {
                "apiVersion": "rbac.authorization.k8s.io/v1",
                "kind": "RoleBinding",
                "metadata": {"name": f"default-{module_name}", "namespace": "default"},
        ...
        rbac_cluster_role_binding = eks_cluster.add_manifest(
            "rbac-orchestrator-cluster-role-binding",
            {
                "apiVersion": "rbac.authorization.k8s.io/v1",
